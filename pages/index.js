      ...
      <div>
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
          <a className="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span className="d-none d-lg-block"><img className="img-fluid img-profile rounded-circle mx-auto mb-2" src="assets/img/profilee.jpg" alt="..." /></span>
          </a>
        ...
        <div className="container-fluid p-0">
          ...
          <section className="resume-section" id="about">
            <div className="resume-section-content">
              ...
              <div className="subheading mb-5">
                ...
                <a href="mailto:titisnurazwanti@gmail.com">titisnurazwanti@gmail.com</a>
              </div>
              <p className="lead mb-5">I am a student at the PGRI Banyuwangi College of Computer Science.  With a bachelor's degree in Informatics Engineering.  I am currently in my final 4th semester.</p>
              <div className="social-icons">
                <a className="social-icon" href="#!"><i className="fab fa-youtube" /></a>
                <a className="social-icon" href="#!"><i className="fab fa-github" /></a>
                <a className="social-icon" href="#!"><i className="fab fa-instagram" /></a>
            ...
            <div className="resume-section-content">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="flex-grow-1">
                  ...
                  <p>Wedding plan is a platform that provides consulting services for planning and implementing wedding events, with complete facilities, professional services and competitive prices. Here I am tasked with creating an application design that is attractive and easily accessible to users.</p>
                </div>
                <div className="flex-shrink-0"><span className="text-primary">January 2022 - June 2022</span></div>
              </div>
              <div className="d-flex flex-column flex-md-row justify-content-between">
                <div className="flex-grow-1">
                  <h3 className="mb-0">Build a Mobile App - FLUTTER</h3>
                  <div className="subheading mb-3">Wedding Plan App</div>
                  <p>Wedding plan is a platform that provides consulting services for planning and implementing wedding events, with complete facilities, professional services and competitive prices. Here we implement standard widgets / objects in designing the user interface design of Android mobile-based applications.</p>
                </div>
                <div className="flex-shrink-0"><span className="text-primary">January 2022 - June 2022</span></div>
              </div>
            </div>
          ...
          <section className="resume-section" id="education">
            <div className="resume-section-content">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div className="flex-shrink-0"><span className="text-primary">2009 - 2014</span></div>
              </div>
              <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="flex-grow-1">
                ...
                <div className="flex-shrink-0"><span className="text-primary">2014 - 2017</span></div>
              </div>
              <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="flex-grow-1">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-between">
                <div className="flex-grow-1">
                  ...
                  <div className="subheading mb-3">Sekolah Tinggi Ilmu Komputer PGRI Banyuwangi</div>
                </div>
                <div className="flex-shrink-0"><span className="text-primary">2020 - Now</span></div>
              </div>
            </div>
          </section>
          <hr className="m-0" />
          ...
          <section className="resume-section" id="interests">
            <div className="resume-section-content">
              ...
              <p>In addition to being a web developer and design, I enjoy my time watching a number of movies, dramas and television shows in the action and fantasy genres.</p>
              <p className="mb-0">My other interest is the interest in work related to accounting. There I felt that I found my true self. There are a lot of things that I do but are out of desire, but for this one thing it's very different and I can feel that way.</p>
            </div>
          </section>
          <hr className="m-0" />
          {/* Awards*/}
            ...
            <div className="resume-section-content">
              ...
              <ul className="fa-ul mb-0">
                ...
                <li>
                  ...
                  1
                  <sup>st</sup>
                  Place - University of Colorado Boulder - Emerging Tech Competition 2020
                </li>
                <li>
                  <span className="fa-li"><i className="fas fa-trophy text-warning" /></span>
                  1
                  <sup>st</sup>
                  Place - University of Colorado Boulder - Adobe Creative Jam 2020 (UI Design Category)
                </li>
                <li>
                  <span className="fa-li"><i className="fas fa-trophy text-warning" /></span>
                  2
                  <sup>nd</sup>
                  Place - University of Colorado Boulder - Emerging Tech Competition 2021
                </li>
                <li>
                  <span className="fa-li"><i className="fas fa-trophy text-warning" /></span>
                  1
